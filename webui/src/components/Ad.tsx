...
// thin dazn
export const top_ad = (classes: any) => (
  <Typography max-width="720px">
    <MediaQuery query="(max-width: 767px)">
      <a
        href="https://px.a8.net/svt/ejp?a8mat=35F4ZJ+1IRWFM+491Q+669JL"
        target="_blank"
        rel="nofollow"
      >
        <img
...
// skyperfect
export const middle_ad1 = (classes: any) => (
  <Typography>
    <a
...
// dazn
export const middle_ad4 = (classes: any) => (
  <Typography>
    <a
      href="https://px.a8.net/svt/ejp?a8mat=35F4ZJ+1IRWFM+491Q+686ZL"
      target="_blank"
...
const middle_ad_game1 = (classes: any) => (
  <Typography className={classes.adTypo}>
    <a
      href="//af.moshimo.com/af/c/click?a_id=1414800&amp;p_id=170&amp;pc_id=185&amp;pl_id=4062&amp;url=https%3A%2F%2Fwww.amazon.co.jp%2Fdp%2FB086GVXQN8"
      rel="nofollow"
...
export const middle_ad_game2 = (classes: any) => (
  <Typography className={classes.adTypo}>
    <a
      target="_blank"
      href="//af.moshimo.com/af/c/click?a_id=1414800&amp;p_id=170&amp;pc_id=185&amp;pl_id=4062&amp;url=https%3A%2F%2Fwww.amazon.co.jp%2FMLB-Show-19-%25E8%25BC%25B8%25E5%2585%25A5%25E7%2589%2588-PS4%2Fdp%2FB07NWWTRZB"
...
export const middle_ad2 = (classes: any) => (
  <Toolbar>
    <MediaQuery query="(max-width: 767px)">
      {middle_ad_game1(classes)}
    </MediaQuery>
    <MediaQuery query="(min-width: 767px)">
      {middle_ad_game_wide(classes)}
    </MediaQuery>
  </Toolbar>
);

export const middle_ad3 = (classes: any) => (
  <Toolbar>
    <MediaQuery query="(max-width: 767px)">
      {middle_ad_game2(classes)}
    </MediaQuery>
    <MediaQuery query="(min-width: 767px)">
      {middle_ad_game_wide(classes)}
    </MediaQuery>
...
// 5*6 dazn
export const bottom_ad = (classes: any) => (
  <Typography>
    <a
